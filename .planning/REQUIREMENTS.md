...
- [x] **RULES-04**: User can reorder rules by drag-and-drop to control first-match-wins priority
...
- [x] **RULES-11**: User-authored categorization rules are automatically applied to transactions at import commit time
